...
const Hero = () => {
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div className={`absolute inset-0 top-[80px] w-full mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        {/* <div className={`absolute inset-0 top-[80px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}> */}
        <div className="xl:w-[70%] w-full flex flex-row items-start justify-start gap-5 pt-5">
